...
import { Message, CreateHTMLParams, CreateMenuParams, ChatNotesPluginSettings } from "./types"


const DEFAULT_SETTINGS: ChatNotesPluginSettings = {
...
class ChatNotesSettingTab extends PluginSettingTab {
